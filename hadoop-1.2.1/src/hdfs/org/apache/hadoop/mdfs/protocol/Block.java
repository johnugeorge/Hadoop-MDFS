...
public class Block implements Writable, Comparable<Block> {
  ...
  public Block(final long blkid) {this(blkid, 0, 0);}
  ...
  public int compareTo(Block b) {
    ...
    if (blockId < b.blockId) {
      ...
      return ( generationStamp <  b.generationStamp) ? -1:(( generationStamp ==  b.generationStamp)? 0:1);
    } else {
      return 1;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return ((this.blockId == that.blockId) && (this.generationStamp  == that.generationStamp)) ;
  }
