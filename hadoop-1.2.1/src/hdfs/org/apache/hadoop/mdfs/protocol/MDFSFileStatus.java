 ...
 */
public class MDFSFileStatus implements Writable {
  static {                                      // register a ctor
    WritableFactories.setFactory
      (MDFSFileStatus.class,
       new WritableFactory() {
         public Writable newInstance() { return new MDFSFileStatus(); }
       });
  }
   ...
   * default constructor
   */
  public MDFSFileStatus() { this(0, false, 0, 0, 0, 0, null, null, null, null); }
   ...
   */
  public MDFSFileStatus(long length, boolean isdir, int block_replication,
