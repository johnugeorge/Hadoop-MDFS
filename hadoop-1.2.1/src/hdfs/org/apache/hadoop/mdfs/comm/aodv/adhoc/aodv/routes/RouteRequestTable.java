...
public class RouteRequestTable {
	...
	/**
	 * 
	 * @return null if no expired route
	 */
	...
	public String toString(){
		synchronized (tableLock) {
			...
			for(RouteRequestEntry f :entries.values()){
				returnString += "\n"+"|Dest: "+f.getDestinationAddress()+" destSeqN: "+f.getDestinationSequenceNumber()+" src: "+f.getSourceAddress()+" broadID: "+f.getBroadcastID()+" retries left: "+f.getRetriesLeft()+" hopCount: "+f.getHopCount()+" TTL: "+(f.getFinalAliveTime()-System.currentTimeMillis());
	...
	public String summary(){
		...
		for(RouteRequestEntry f :entries.values()){
			summary += "Dest: " + f.getDestinationAddress() + " Src: " + f.getSourceAddress() + " Distance: " + f.getHopCount() + " \n";
		}
		return summary;
	}
}